...
batch_size = 500  # Кількість записів за один запит
pause_duration = 3  # Перерва між запитами (у секундах)

# Параметри MySQL
mysql_host = "wealth0.mysql.tools"
mysql_user = "wealth0_raid"
mysql_password = "ku549M4XnR"
...
def insert_records_into_mysql(records):
    try:
        ...
        if connection.is_connected():
            ...
            insert_query = """
            INSERT INTO et_AccumulationRegister_Зарплата (
...
def fetch_data_from_api():
    ...
    while True:
        try:
            ...
            api_url = f"{base_url}?$format=json&$top={batch_size}&$skip={skip}"
